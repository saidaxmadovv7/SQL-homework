...
select  e1.Name as emp_name1,e2.Name as emp_name2,e1.ManagerID from Employees as e1
...
select  e1.Name as emp_name1,e2.Name as emp_name2,e1.ManagerID,e1.Salary from Employees as e1
join Employees as e2 on e1.ManagerID=e2.ManagerID and e1.EmployeeID<e2.EmployeeID
where  e1.ManagerID is not null  and e1.Salary>60000
...
(5, 'Finance');
 ...
 left join Departments as d on e.EmployeeID=d.DepartmentID

 select e1.Name,e2.ManagerID from Employees as e1
  ...
  where d.DepartmentName='Human Resources'
   ...
   select  d.DepartmentName,count(e.EmployeeID) as Emp_count  from Employees as e
   join Departments as d on e.DepartmentID=d.DepartmentID
...
INSERT INTO Prooducts (ProductID, ProductName, Price, Category, StockQuantity, SupplierID) VALUES
...
select  s.SupplierName,p.ProductName from Prooducts as p
left join Suppliers as s on p.SupplierID=s.SupplierID




select  p.ProductID,p.ProductName from Prooducts as p
...
select  s.SaleID, p.ProductName,s.SaleAmount  from Prooducts as p
...
select p.ProductID,p.ProductName,c.CategoryName  from Prooducts as p
join Categories as c on p.Category=c.CategoryName
...
select s.Name,c.CourseName from Students as s
  join Courses as c on s.StudentID=c.CourseID
