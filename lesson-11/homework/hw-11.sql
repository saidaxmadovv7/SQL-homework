...
select d.DepartmentName,sum(e.Salary) as Max_salary  from Employees as e
join Departments as d on e.DepartmentID=d.DepartmentID
...
select c.FirstName,o.Quantity  as total_orders from Orders as o
join Customers as c on o.CustomerID=c.CustomerID
group by c.FirstName,o.Quantity


select  c.FirstName,o.OrderDate as mostrecentorder from Customers as c
 left join Orders as o on c.CustomerID=o.CustomerID
group by  c.FirstName,o.OrderDate 

select  c.FirstName,sum(o.TotalAmount) as total_order from Customers as c
join Orders as o on c.CustomerID=o.CustomerID
...
select p.ProductName,s.SupplierName from Prooducts as p
 ...
 select p.ProductName,s.SaleDate,s.SaleAmount   from Prooducts as p
 join Sales as s on p.ProductID=s.ProductID
 where year(s.SaleDate)=2022 or s.SaleAmount>400


 select p.ProductName,sum(s.SaleAmount) as total_salesamount  from Prooducts as p
 join Sales as s on p.ProductID=s.ProductID
 group by  p.ProductName,s.SaleAmount


 select   p.ProductName,s.SaleDate,p.StockQuantity from Prooducts as p
 join Sales as s on p.ProductID=s.ProductID
